...
import { clearCart, removePizzaFromCart, plusPizza, minusPizza } from '../redux/actions/cart';
...
function FullCart() {
  ...
  const onRemovePizza = (id) => {
    if (window.confirm('Вы действительно хотите удалить пиццу?')) dispatch(removePizzaFromCart(id));
  };
  return (
    <div className="cart">
